...
st.markdown("Narrow AI is also known as weak AI\nIt is an application of artificial intelligence technologies to enable a high functioning system that replicates human intelligence for a dedicated purpose.\nExample for Narrow AI\nImage and facial recognition systems\nChatbots and conversational assistants\nSelf-driving vehicles\nPredictive maintenance models")
st.header("What is General AI ?")
st.markdown("Artificial general intelligence (AGI) is the representation of generalized human cognitive abilities in software so that, faced with an unfamiliar task, the AGI system could find a solution.\nExample for General AI\nCreativity\nSensory perception\nFine motor skills\nNatural language understanding\nNavigation")
st.header("What Is Super AI ?")
st.markdown("Artificial superintelligence (ASI) is a form of AI that is capable of surpassing human intelligence by manifesting cognitive skills and developing thinking skills of its own.\nExample\nDevelopment of large language models\nAdvancements in multimodal AI\nAI-driven programming\nVertical integration of AI solutions\nAI-generated inventions")
